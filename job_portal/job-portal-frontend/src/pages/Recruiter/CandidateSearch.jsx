...
export default function CandidateSearch() {
  ...
  async function handleSearch(e) {
    ...
    try {
      ...
      setCandidates(res.data.data || []);
      toast.info(`${res.data.data?.length || 0} candidate(s) found`);
    } catch (err) {
      console.error(err);
  ...
  // 📄 View single candidate (REAL API)
          ...
          <main className="main-col">
            <div className="top-row" style={{ marginBottom: 12 }}>
              <div>
                ...
                <div className="subtitle">
                  Browse all registered job seekers
                </div>
              </div>
            ...
            <section className="card" style={{ marginTop: 12 }}>
              <div className="candidate-grid">
                {candidates.map(c => (
                  <article key={c._id} className="candidate-card">
                    <div>
            ...
            <div style={{ marginTop: 8, display: 'flex', gap: 12 }}>
              ...
              <div style={{ width: 220 }}>
                <button
                  className="btn"
                  onClick={() =>
                    toast.info('Download resume — coming soon')
                  }
                >
                  Download Resume
                </button>
                <button
                  ...
                  style={{ marginTop: 8 }}
                  onClick={() =>
                    toast.success('Shortlisted candidate')
                  }
                >
                  Shortlist
                </button>
